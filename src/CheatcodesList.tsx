...
export const CheatcodesList = ({ cheatcodes }: { cheatcodes: Cheatcodes }) => {
  ...
  return (
    <div
      className="overflow-auto flex flex-col gap-1 p-2 bg-black-800/50 text-gray-400 h-full pointer-events-auto"
      style={{ background: "rgba(0,0,0,0.2)" }}
    >
      {_.chunk(Object.entries(cheatcodes), 2).map((chunk, i) => (
        <div className="grid grid-cols-2 gap-1">
          {chunk.map(([funcName], i) => {
            return (
              <div
